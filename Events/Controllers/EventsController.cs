...
namespace Events.Controllers
{
    public class EventsController : Controller
    {
        ...
        private readonly IToastNotification _toastNoti;

        public EventsController(ApplicationDbContext context,
            UserManager<ApplicationUser> userManager,
            IToastNotification toastNoti)
        {
            _context = context;
            _userManager = userManager;
            _toastNoti = toastNoti;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Start,End,Location,IsPublic,TotalTicket,Price")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Start,End,Location,IsPublic,TotalTicket,Price")] Event @event)
        {
            if (id != @event.Id)
            {
                return NotFound();
